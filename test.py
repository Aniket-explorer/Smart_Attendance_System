...
# Check if the number of face samples matches the number of labels
if len(FACES) != len(LABELS):
    raise ValueError("Number of face samples does not match number of labels!")
...
while True:
    ...
    # Add a check to ensure frame is not empty
    if frame is None:
        break
